...
def parameter_parser():
    ap = argparse.ArgumentParser(description="LSM-GCN.")
    ...
    ap.add_argument('--dropout_gcn', type=float, default=0.5, help='Dropout rate. Default is 0.5.')
    ...
    ap.add_argument('--feat_balance', type=float, default=0.5, help='Balancing param of feature.')
    ap.add_argument('--score_balance', type=float, default=0.3, help='Balancing param of block.')
    ...
    ap.add_argument('--epoch_gcn', type=int, default=400, help='Max number of epochs for gcn. Default is 1600.')
